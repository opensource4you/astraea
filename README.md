...
14. --create.report: put the metrics into a file if this flag is set. Default: false
15. --report.path: A path to place the CSV file. Default: "./"
16. --report.format: Select output file format. Available format: "csv", "json".
