...
public class ConsumerPartitionAssignorTest {
  ...
  void testSubscriptionConvert() {
    ...
    var ourSubscription =
        org.astraea.common.consumer.ConsumerPartitionAssignor.Subscription.from(kafkaSubscription);
  ...
  void testGroupSubscriptionConvert() {
    ...
    var ourGroupSubscription =
        org.astraea.common.consumer.ConsumerPartitionAssignor.GroupSubscription.from(
