...
public abstract class BalancerConfigTestSuite {
  ...
  public void testBalancingModeClean() {
          ...
          () ->
              balancer.offer(
                  AlgorithmConfig.builder()
                      ...
                      .timeout(Duration.ofSeconds(2))
                      .configs(customConfig.raw())
                      .config(BalancerConfigs.BALANCER_BROKER_BALANCING_MODE, "default:clean")
                      .build()),
          testName);
    }
      ...
      var plan =
          balancer.offer(
              AlgorithmConfig.builder()
                  ...
                  .timeout(Duration.ofSeconds(2))
                  .configs(customConfig.raw())
                  .config(BalancerConfigs.BALANCER_BROKER_BALANCING_MODE, "0:clean,1:clean,2:clean")
                  .build());
          ...
          () ->
              balancer.offer(
                  AlgorithmConfig.builder()
                      ...
                      .configs(customConfig.raw())
                      .config(
                          BalancerConfigs.BALANCER_BROKER_BALANCING_MODE, "0:clean,1:clean,2:clean")
                      .build()));
    }
              ...
              () ->
                  balancer.offer(
                      AlgorithmConfig.builder()
                          ...
                          // clear broker 3
                          .config(BalancerConfigs.BALANCER_BROKER_BALANCING_MODE, "3:clean")
          ...
          () ->
              balancer.offer(
                  AlgorithmConfig.builder()
                      ...
                      .config(
                          BalancerConfigs.BALANCER_BROKER_BALANCING_MODE,
                          "0:clean,1:balancing,default:excluded")
...

    {
      ...
      // 2. There are brokers that need to be clean.
      ...
      Assertions.assertNotEquals(
          ...
          balancer.offer(
              AlgorithmConfig.builder()
                  ...
                  .config(BalancerConfigs.BALANCER_BROKER_BALANCING_MODE, "1:clean")
                  .timeout(Duration.ofSeconds(2))
                  .build()),
          testName);
    }
