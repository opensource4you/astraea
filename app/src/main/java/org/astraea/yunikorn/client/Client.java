  ...
  private int getApplication(String body) {
    ...
    try {
      ...
      for (int i = 0; i < totalApplication; i++) {
        ...
        var resources = application.get("usedResource").toString();
      ...
      this.evaluation.setResources(
          Long.valueOf(totalResources[0]).toString(), Long.valueOf(totalResources[1]).toString());
