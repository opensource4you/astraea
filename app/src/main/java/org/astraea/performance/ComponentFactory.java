...
public interface ComponentFactory {
  ...
  /** Used for creating Kafka producer, consumer, admin of the same Kafka server.
   * The consumers generated by the same object from `fromKafka(brokers)` have the same groupID
   * */
