...
public class DependencyRecord<K,V> {
     ...
     */
    public ProducerRecord<K,V> orderRecord(String topic, Integer partition, Long timestamp, K key, V value) {
     ...
     */
    public ProducerRecord<K,V> orderRecord(String topic, Integer partition, K key, V value, Iterable<Header> headers) {
