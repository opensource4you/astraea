...
//      new Node[] {
//        new Node(0, "localhost", 99), new Node(1, "localhost", 100), new Node(12, "localhost",
// 101)
//      };
...
//        mockConstruction(SmoothWeightPartitioner.ThreadSafeSmoothPartitioner.class)) {
//
...
//    var configs =
//        Map.of(
//            ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, "localhost:11111", "jmx_server",
// jmxAddresses);
//
...
//    var partitioners = new ArrayList<SmoothWeightPartitioner>();
...
//
// mockConstruction(SmoothWeightPartitioner.ThreadSafeSmoothPartitioner.class)) {
//                      var partitioner = new SmoothWeightPartitioner();
...
//
//    for (SmoothWeightPartitioner partitioner : partitioners) {
...
//
//      var partitioner0 = new SmoothWeightPartitioner();
//      var props0 =
...
//      verify(smoothPartitioner0, never()).partition(anyString(), any(), any(), any(), any(),
// any());
//      verify(smoothPartitioner0, never()).close();
//
//      var partitioner1 = new SmoothWeightPartitioner();
//      var props1 =
...
//      verify(smoothPartitioner1, never()).partition(anyString(), any(), any(), any(), any(),
// any());
